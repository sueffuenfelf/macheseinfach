...
export const SEARCH_FIXTURES: SearchFixture[] = [
    ...
    { query: 'einheiten', expectIdContains: 'area:einheiten', expectTopKind: 'area' },
    ...
    { query: 'json formatieren', expectIdContains: 'json-format' },
    { query: 'base64', expectIdContains: 'base64' },
    { query: 'vertrag unterschreiben', expectIdContains: 'pdf-sign' },
    { query: 'wort zählen', expectIdContains: 'word-counter' },
    { query: 'werktage', expectIdContains: 'business-days' },
];
