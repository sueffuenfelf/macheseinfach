        ...
        <WidgetCard title="GiroCode Mini" embedded={embedded}>
            <div className="space-y-2">
                ...
                <input
                    ...
                    placeholder="IBAN"
                    className="ms-input min-h-11 font-mono text-[12px] sm:min-h-0"
                />
                <input
                    value={amount}
                ...
                <button
                    type="button"
                    className="ms-btn min-h-11 w-full py-1 text-[12px] sm:min-h-0"
                    disabled={!ready}
                ...
                <div className="grid min-h-[6.5rem] place-items-center rounded-[8px] border-2 border-black bg-[var(--color-chip)]">
                    {image ? (
                        <img
                            src={image}
                            alt="GiroCode Vorschau"
                            className="h-full max-h-[6.25rem] w-full max-w-[6.25rem] object-contain p-1"
                        />
                    ) : (
                        <span className="text-[11px]">Noch kein QR</span>
                    )}
                </div>
            </div>
        </WidgetCard>
